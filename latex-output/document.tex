...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{J.4}Consolidation into themes.}%
\textbf{Table J.4} Consolidation into themes. The codes constituting each of the final five themes, with the rationale for grouping.
