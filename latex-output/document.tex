...
Gaze accuracy and gaze precision are reported in degrees of visual angle. Interaction breakdown counts are totals across the five recorded categories, the per-category decomposition of which is given in Table 5.3. First-pass calibration success is recorded as pass or fail. Tables K.1 to K.4 report this dataset grouped by measure type: K.1 covers setup and calibration efficiency together with interaction breakdown counts; K.2 covers the subjective measures (NASA-TLX, SUS, and calibration confidence); K.3 covers eye-tracking calibration quality; and K.4 covers the EDA baseline.

\Needspace{24\baselineskip}
\begin{landscape}
\begingroup\let\small\footnotesize\setlength{\tabcolsep}{4pt}
\begingroup\let\small\footnotesize\setlength{\tabcolsep}{4pt}
\begin{longtable}[]{@{}>{\raggedright\arraybackslash}p{0.0597\columnwidth}>{\raggedright\arraybackslash}p{0.1431\columnwidth}>{\raggedright\arraybackslash}p{0.1431\columnwidth}>{\raggedright\arraybackslash}p{0.1431\columnwidth}>{\raggedright\arraybackslash}p{0.1431\columnwidth}>{\raggedright\arraybackslash}p{0.1431\columnwidth}>{\raggedright\arraybackslash}p{0.1431\columnwidth}@{}}
\toprule\noalign{}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{K.1}Per-participant efficiency and interaction breakdowns.}%
\textbf{Table K.1} Per-participant efficiency and interaction breakdowns. Setup time, calibration time, and interaction breakdown counts for each participant (N = 12) in both conditions.
\endgroup
\end{landscape}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{K.2}Per-participant subjective measures.}%
\textbf{Table K.2} Per-participant subjective measures. Raw NASA-TLX, System Usability Scale, and calibration confidence for each participant (N = 12) in both conditions.
\endgroup
\end{landscape}
...
\begingroup\let\small\footnotesize\setlength{\tabcolsep}{4pt}
\begingroup\let\small\footnotesize\setlength{\tabcolsep}{4pt}
\begin{longtable}[]{@{}>{\raggedright\arraybackslash}p{0.0581\columnwidth}>{\raggedright\arraybackslash}p{0.1045\columnwidth}>{\raggedright\arraybackslash}p{0.1045\columnwidth}>{\raggedright\arraybackslash}p{0.1045\columnwidth}>{\raggedright\arraybackslash}p{0.1045\columnwidth}>{\raggedright\arraybackslash}p{0.1045\columnwidth}>{\raggedright\arraybackslash}p{0.1045\columnwidth}>{\raggedright\arraybackslash}p{0.1045\columnwidth}>{\raggedright\arraybackslash}p{0.1045\columnwidth}@{}}
\toprule\noalign{}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{K.3}Per-participant eye-tracking calibration quality.}%
\textbf{Table K.3} Per-participant eye-tracking calibration quality. Gaze accuracy, gaze precision, valid data yield, and first-pass calibration success for each participant (N = 12) in both conditions.
\endgroup
\end{landscape}

\Needspace{24\baselineskip}
\begin{longtable}[]{@{}>{\raggedright\arraybackslash}p{0.2318\columnwidth}>{\raggedright\arraybackslash}p{0.3671\columnwidth}>{\raggedright\arraybackslash}p{0.3671\columnwidth}@{}}
\toprule\noalign{}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{K.4}Per-participant mean resting EDA baseline.}%
\textbf{Table K.4} Per-participant mean resting EDA baseline. Mean resting electrodermal activity in microsiemens for each participant (N = 12) in both conditions.
