...
Designing and Evaluating Usability-Centred Onboarding and Calibration Workflows in Multi-Modal Research Platforms.
...
\protect\hyperlink{abstract}{\textbf{Abstract 6}}

\protect\hyperlink{list-of-abbreviations}{\textbf{List of Abbreviations 7}}

\protect\hyperlink{list-of-figures-list-of-tables}{\textbf{List of Figures / List of Tables 8}}

\protect\hyperlink{introduction}{\textbf{1. Introduction 9}}

\begin{quote}
\protect\hyperlink{background-and-motivation}{1.1 Background and Motivation 9}

\protect\hyperlink{problem-statement}{1.2 Problem Statement 10}

\protect\hyperlink{research-aim}{1.3 Research Aim 11}

\protect\hyperlink{research-questions}{1.4 Research Questions 12}

\protect\hyperlink{hypotheses}{1.5 Hypotheses 13}

\protect\hyperlink{thesis-structure}{1.6 Thesis Structure 14}
\end{quote}

\protect\hyperlink{literature-review}{\textbf{2. Literature Review 16}}

\begin{quote}
\protect\hyperlink{review-methodology}{2.1 Review Methodology 16}

\protect\hyperlink{search-strategy}{2.1.1 Search Strategy 17}

\protect\hyperlink{search-strings}{2.1.2 Search Strings 17}

\protect\hyperlink{ai-assisted-search-prompts}{2.1.3 AI-Assisted Search Prompts 18}

\protect\hyperlink{inclusion-and-exclusion-criteria}{2.1.4 Inclusion and Exclusion Criteria 19}

\protect\hyperlink{screening-and-thematic-synthesis}{2.1.5 Screening and Thematic Synthesis 20}

\protect\hyperlink{reference-management}{2.1.6 Reference Management 21}

\protect\hyperlink{the-preparation-burden-of-multimodal-measurement-and-the-case-for-unified-workflows}{2.2 The Preparation Burden of Multimodal Measurement and the Case for Unified Workflows 21}

\protect\hyperlink{the-analytical-value-of-multimodal-integration}{2.3 The Analytical Value of Multimodal Integration 23}

\protect\hyperlink{onboarding-friction-in-research-tools}{2.4 Onboarding Friction in Research Tools 23}

\protect\hyperlink{fragmented-vs-unified-workflows}{2.5 Fragmented vs Unified Workflows 24}

\protect\hyperlink{onboarding-calibration-and-validation-as-an-interaction-process-and-the-research-gap}{2.6 Onboarding, Calibration and Validation as an Interaction Process, and the Research Gap 25}
\end{quote}

\protect\hyperlink{system-design-and-implementation}{\textbf{3. System Design and Implementation 26}}

\begin{quote}
\protect\hyperlink{design-basis}{3.1 Design Basis 26}

\protect\hyperlink{the-sensa-platform}{3.2 The Sensa Platform 26}

\protect\hyperlink{authors-contribution}{3.3 Author's Contribution 27}

\protect\hyperlink{study-setup-and-onboarding}{3.3.1 Study Setup and Onboarding 28}

\protect\hyperlink{project-details-readiness-verification-and-calibration-overview}{3.3.2 Project Details, Readiness Verification and Calibration Overview 35}

\protect\hyperlink{eye-tracker-calibration}{3.3.3 Eye Tracker Calibration 40}

\protect\hyperlink{the-eye-tracker-validation-layer}{3.3.4 The Eye-Tracker Validation Layer 46}

\protect\hyperlink{rationale}{3.3.4.1 Rationale 46}

\protect\hyperlink{measured-quantities}{3.3.4.2 Measured quantities 46}

\protect\hyperlink{the-five-point-validation-grid-and-gaze-trace}{3.3.4.3 The five-point validation grid and gaze trace 47}

\protect\hyperlink{measuring-accuracy-and-precision}{3.3.4.4 Measuring accuracy and precision 48}

\protect\hyperlink{result-visualisation-and-pass-criteria}{3.3.4.5 Result visualisation and pass criteria 51}

\protect\hyperlink{system-boundary}{3.3.4.6 System boundary 54}

\protect\hyperlink{biometric-sensor-calibration}{3.3.5 Biometric Sensor Calibration 54}

\protect\hyperlink{other-modules}{3.4 Other Modules 62}

\protect\hyperlink{design-rationale-and-guiding-principles}{3.5 Design Rationale and Guiding Principles 63}

\protect\hyperlink{application-of-nielsens-usability-heuristics}{3.6 Application of Nielsen\textquotesingle s Usability Heuristics 63}
\end{quote}

\protect\hyperlink{methodology}{\textbf{4. Methodology 65}}

\begin{quote}
\protect\hyperlink{research-design}{4.1 Research Design 65}

\protect\hyperlink{fragmented-workflow-baseline-condition}{4.1.1 Fragmented Workflow (Baseline Condition): 66}

\protect\hyperlink{unified-workflow-proposed-condition}{4.1.2 Unified Workflow (Proposed Condition): 66}

\protect\hyperlink{participants}{4.2 Participants 67}

\protect\hyperlink{apparatus-and-materials}{4.3 Apparatus and Materials 68}

\protect\hyperlink{experimental-procedure}{4.4 Experimental Procedure 69}

\protect\hyperlink{fragmented-condition-procedure}{4.4.1 Fragmented condition procedure 71}

\protect\hyperlink{unified-condition-procedure}{4.4.2 Unified condition procedure 72}

\protect\hyperlink{eye-tracking-calibration-quality-check}{4.4.3 Eye-Tracking Calibration Quality Check 73}

\protect\hyperlink{dependent-variables-metrics}{4.5 Dependent Variables (Metrics) 74}

\protect\hyperlink{efficiency-measures-relates-to-h1}{4.5.1 Efficiency Measures (relates to H1) 75}

\protect\hyperlink{subjective-user-experience-measures-relates-to-h2-h3}{4.5.2 Subjective User Experience Measures (relates to H2 \& H3) 75}

\protect\hyperlink{interaction-breakdown-metrics-relates-to-h4}{4.5.3 Interaction Breakdown Metrics (relates to H4): 75}

\protect\hyperlink{calibration-outcome-quality-relates-to-h5}{4.5.4 Calibration Outcome Quality (relates to H5) 76}

\protect\hyperlink{eda-baseline-comparability-check-not-a-scored-h5-dimension}{4.5.5 EDA baseline (comparability check, not a scored H5 dimension) 77}

\protect\hyperlink{data-analysis}{4.6 Data Analysis 79}

\protect\hyperlink{quantitative-analysis}{4.6.1 Quantitative Analysis 79}

\protect\hyperlink{step-1-normality-screening-and-the-choice-of-test}{4.6.1.1 Step 1: Normality screening and the choice of test 80}

\protect\hyperlink{step-2-reporting-the-effect-sizes}{4.6.1.2 Step 2: Reporting the effect sizes 80}

\protect\hyperlink{step-3-analysing-the-binary-outcome-using-mcnemars-test}{4.6.1.3 Step 3: Analysing the binary outcome using McNemar's test 80}

\protect\hyperlink{step-4-controlling-for-multiple-comparisons}{4.6.1.4 Step 4: Controlling for multiple comparisons 81}

\protect\hyperlink{the-interpretive-stance-on-h5}{4.6.1.5 The interpretive stance on H5 81}

\protect\hyperlink{the-eda-comparability-check}{4.6.1.6 The EDA comparability check 82}

\protect\hyperlink{qualitative-analysis}{4.6.2 Qualitative Analysis 82}

\protect\hyperlink{coding-approach}{4.6.2.1 Coding approach 83}

\protect\hyperlink{analytic-procedure}{4.6.2.2 Analytic procedure 83}

\protect\hyperlink{coder-and-reflexivity}{4.6.2.3 Coder and reflexivity 84}

\protect\hyperlink{integration-with-the-quantitative-findings}{4.6.2.4 Integration with the quantitative findings 84}

\protect\hyperlink{validity-and-reliability}{4.7 Validity and Reliability 85}

\protect\hyperlink{internal-validity}{4.7.1 Internal Validity 85}

\protect\hyperlink{external-validity}{4.7.2 External Validity 86}

\protect\hyperlink{construct-validity}{4.7.3 Construct Validity 86}

\protect\hyperlink{reliability}{4.7.4 Reliability 87}
\end{quote}

\protect\hyperlink{results}{\textbf{5. Results 89}}

\begin{quote}
\protect\hyperlink{quantitative-results}{5.1 Quantitative Results 89}

\protect\hyperlink{setup-and-calibration-time-h1}{5.1.1 Setup and calibration time (H1) 92}

\protect\hyperlink{perceived-workload-nasa-tlx-h2}{5.1.2 Perceived workload, NASA-TLX (H2) 93}

\protect\hyperlink{perceived-usability-sus-h3}{5.1.3 Perceived usability, SUS (H3) 94}

\protect\hyperlink{calibration-confidence-secondary-measure}{5.1.4 Calibration confidence (secondary measure) 95}

\protect\hyperlink{interaction-breakdowns-h4}{5.1.5 Interaction breakdowns (H4) 96}

\protect\hyperlink{calibration-quality-h5}{5.1.6 Calibration quality (H5) 97}

\protect\hyperlink{eda-baseline-comparability-check}{5.1.7 EDA baseline comparability check 100}

\protect\hyperlink{summary-of-quantitative-results}{5.1.8 Summary of quantitative results 101}

\protect\hyperlink{qualitative-findings}{5.2 Qualitative Findings 103}

\protect\hyperlink{theme-1-confidence-grounded-in-system-feedback}{5.2.1 Theme 1: Confidence grounded in system feedback 103}

\protect\hyperlink{theme-2-the-burden-of-coordinating-fragmented-tools}{5.2.2 Theme 2: The burden of coordinating fragmented tools 104}

\protect\hyperlink{theme-3-guidance-from-the-system}{5.2.3 Theme 3: Guidance from the system 104}

\protect\hyperlink{theme-4-the-limits-of-guidance}{5.2.4 Theme 4: The limits of guidance 105}

\protect\hyperlink{theme-5-familiarity-and-order-effects}{5.2.5 Theme 5: Familiarity and order effects 105}

\protect\hyperlink{summary-of-qualitative-findings}{5.2.6 Summary of qualitative findings 106}
\end{quote}

\protect\hyperlink{discussion}{\textbf{6. Discussion 107}}

\begin{quote}
\protect\hyperlink{overview}{6.1 Overview 107}

\protect\hyperlink{setup-and-calibration-efficiency-h1}{6.2 Setup and calibration efficiency (H1) 108}

\protect\hyperlink{perceived-workload-and-usability-h2-h3}{6.3 Perceived workload and usability (H2, H3) 108}

\protect\hyperlink{interaction-breakdowns-h4-1}{6.4 Interaction breakdowns (H4) 109}

\protect\hyperlink{calibration-quality-h5-1}{6.5 Calibration quality (H5) 109}

\protect\hyperlink{the-two-directional-role-of-visible-system-state}{6.6 The two-directional role of visible system state 111}

\protect\hyperlink{design-implications}{6.7 Design implications 111}

\protect\hyperlink{limitations}{6.8 Limitations 112}
\end{quote}

\protect\hyperlink{conclusion-and-future-work}{\textbf{7. Conclusion and Future Work 113}}

\begin{quote}
\protect\hyperlink{summary-and-conclusions}{7.1 Summary and conclusions 113}

\protect\hyperlink{contributions}{7.2 Contributions 115}

\protect\hyperlink{future-work}{7.3 Future work 116}
\end{quote}

\protect\hyperlink{list-of-references}{\textbf{List of References {[}needs to update!{]} 117}}

\protect\hyperlink{appendices}{\textbf{Appendices 122}}

\begin{quote}
\protect\hyperlink{appendix-a1-task-prompt-fragmented-workflow}{Appendix A1: Task Prompt (Fragmented Workflow) 122}

\protect\hyperlink{appendix-a2-task-prompt-unified-workflow}{Appendix A2: Task Prompt (Unified Workflow) 125}

\protect\hyperlink{appendix-b-participant-intake-form}{Appendix B: Participant Intake Form 127}

\protect\hyperlink{appendix-c-participant-information-sheet}{Appendix C: Participant Information Sheet 129}

\protect\hyperlink{appendix-d-informed-consent-form}{Appendix D: Informed Consent Form 133}

\protect\hyperlink{appendix-e-observation-and-breakdown-log-sheets}{Appendix E: Observation and Breakdown Log Sheets 135}

\protect\hyperlink{appendix-f-post-task-open-questionnaire}{Appendix F: Post-Task Open Questionnaire 139}

\protect\hyperlink{appendix-g-post-task-objective-questionnaires}{Appendix G: Post-Task Objective Questionnaires 141}

\protect\hyperlink{appendix-h-tobii-eye-tracking-software-manual-extract}{Appendix H: Tobii 4C Manual Extract 144}

\protect\hyperlink{appendix-i-eda-sensor-reference-datasheet}{Appendix I: EDA Manual Reference Sheet 144}

\protect\hyperlink{appendix-j-full-thematic-coding}{Appendix J: Full Thematic Coding 145}

\protect\hyperlink{appendix-k-per-participant-quantitative-data}{\textbf{Appendix K: Per-Participant Quantitative Data 165}}
\end{quote}

\protect\hyperlink{ai-usage-disclosure}{\textbf{AI Usage Disclosure 170}}

\protect\hyperlink{declaration-of-authenticity}{\textbf{Declaration of Authenticity 170}}
...
\section{\texorpdfstring{\hfill\break
List of Abbreviations }{ List of Abbreviations }}\label{list-of-abbreviations}}
...
The use of biometric sensors in multimodal research platforms is rapidly increasing, especially in systems that combine eye tracking with sensors such as electroencephalography (EEG). These platforms are increasingly used in Human-Computer Interaction (HCI) and usability engineering research (Zhu \& Lv, 2023, p. 2). Gaspar-Figueiredo et al. (2026, pp. 1-3) argue that multimodal sensor systems can record behavioral and physiological signals, such as gaze behaviour and EEG activity. Their main advantage over traditional self-report methods is that they provide objective, real-time insights into users\textquotesingle{} cognitive workload and emotional responses, while surveys and interviews mainly capture subjective user perceptions,which participants can only report consciously. By recording objective, measurable data, multimodal setups have become important for studies in fields including automotive HMI, UX research, and adaptive interface design (Aloi et al., 2024, p. 1; Gaspar-Figueiredo et al., 2026, p. 1).
...
This thesis is organised into seven chapters. This first chapter has introduced the problem of fragmented multi-sensor setup, stated the research aim, and set out the research questions and hypotheses that the study addresses.
...
\begin{center}\includegraphics[max width=\linewidth,max totalheight=0.85\textheight]{diagrams/figure-3.1.pdf}\end{center}

\phantomsection\addcontentsline{lof}{figure}{\protect\numberline{3.1}The Sensa platform at a glance.}
\textbf{Figure 3.1} The Sensa platform at a glance. Sensa is organised into six functional modules: study setup and onboarding, sensor calibration, session recording, data analysis, data interpretation, and data export

The onboarding and calibration workflow was first designed as a high-fidelity prototype in Figma (Figma Inc., 2026), which allowed the information architecture, step sequencing, and interaction patterns to be defined and iterated before any code was written. It was then realised in the implemented platform, the working web frontend built by the development team, which follows that design. The prototype thus translates the fragmented multimodal study workflow into a structured, guided interface concept, defining how researchers move through setup, calibration, recording, analysis, and interpretation in a coherent sequence. The chapters that follow describe the design as realised, and the screenshots throughout are taken from the implemented platform rather than the prototype.
...
\begin{center}\includegraphics[max width=\linewidth,max totalheight=0.85\textheight]{diagrams/figure-3.5.pdf}\end{center}
...
\begin{center}\includegraphics[max width=\linewidth,max totalheight=0.85\textheight]{diagrams/figure-3.10.pdf}\end{center}
...
\textbf{Precision} captures the dispersion of the individual gaze samples about their own mean, independently of the accuracy offset. It is computed as the spatial standard deviation of the N valid binocular samples for a target, converted to a visual angle by the same inverse-tangent relation:

spread = √{[} (1/N) × Σ ( (sampleX − meanGazeX)² + (sampleY − meanGazeY)² ) {]}

precision (°) = arctan( ( spread × W ) / d )

where the summation Σ runs over the N valid binocular samples collected for the target. This standard-deviation form is one of the two dispersion estimators recommended for spatial precision; the alternative expresses precision as the root-mean-square of the distances between temporally successive samples as used by Nyström et al. (2013, p. 280) and described by Holmqvist et al. (2012, p. 48). The standard-deviation estimator is used here because it summarises the overall stability of the fixation rather than sample-to-sample jitter.

Reporting accuracy, precision, and valid-data yield together follows the standardised data-quality report proposed by the latter authors (Holmqvist et al., 2012, p. 49). Valid data yield is the proportion of collection samples containing a valid binocular estimate, N\_valid/N\_all (Nyström et al., 2013, p. 280).

Two simplifications of this real-time implementation should be stated.

First, the metrics are computed over all valid samples in each collection window rather than over an algorithmically detected fixation. Holmqvist et al. (2012, p. 50) note that data-quality values computed from fixation samples are directly dependent on the fixation-detection algorithm used, and that different algorithms produce markedly different results from the same data; they raise the omission of the fixation-detection stage as an open question rather than a settled convention. Computing over recorded samples avoids that dependency at the cost of including any saccade samples present, and it distinguishes the present procedure from Nyström et al. (2013, p. 280), who apply fixation detection and additional sample-selection criteria before computing the same quantities.

Second, the tracker reports gaze in normalised display coordinates, with the horizontal component normalised by display width and the vertical by display height. The implementation forms a single normalised Euclidean error from the two components and scales it by the display width alone, rather than converting each component to millimetres separately. On a 16:9 display this overestimates any error carrying a vertical component, by a factor of up to 1.78 for a purely vertical error, leaving purely horizontal errors unaffected. Reported accuracy and precision values are therefore inflated by a small, systematic, direction-dependent factor. Because the same instrument and conversion are applied in both conditions during the empirical study, this factor is constant and cancels in the within-participant paired comparison on which H5 is evaluated. It does not affect the relative result, but it reinforces that the reported values are instrument-relative rather than absolute ground truth (Chapters 3.3.4.6, 4.4.3, and 4.7.4).

The author defined the methodological decisions behind this process (live distance measurement, binocular data reduction, angular error conversion, and the validation threshold) and verified the outputs against the hardware and the eye-tracking literature. The implementation was developed through AI-assisted pair-programming using Claude Code (Anthropic).

The validation threshold is configurable by the user (Figure 3.14) during Step 3 of eye-tracker calibration and reported together with the result in Step 4. By default it is set to 3 degrees, providing a small tolerance margin relative to the cited realistic upper accuracy range of approximately 2.5 degrees for consumer eye trackers such as the Tobii 4C (Mikalef et al., 2023, p. 4).

\hypertarget{result-visualisation-and-pass-criteria}{%
\paragraph{3.3.4.5 Result visualisation and pass criteria}\label{result-visualisation-and-pass-criteria}}

Validation results are presented as a two-dimensional scatter plot that overlays, in normalised display space, the five target locations and the corresponding mean gaze positions, with a dashed offset line connecting each target to its measured gaze (Figure 3.18 and Figure 3.19). The length of each offset line is the visual representation of the accuracy error, and elements are colour-coded against the pass threshold (within threshold in green, exceeding it in red), so the operator can see at a glance both the magnitude and the spatial pattern of any systematic offset, for example a consistent downward displacement indicating a vertical bias. A target passes if its accuracy is within the pass threshold (3 degrees of visual angle by default, as defined in Chapter 3.3.4.4); the session passes if a sufficient number of targets are valid and the mean accuracy across valid targets is within that threshold. Presenting the measurement outcome visibly and immediately follows established usability guidance on visibility of system status (Nielsen, 1994).
...
\begin{center}\includegraphics[max width=\linewidth,max totalheight=0.85\textheight]{diagrams/figure-3.20.pdf}\end{center}
...
\phantomsection\addcontentsline{lof}{figure}{\protect\numberline{3.26}[NEED TO UPDATE IMAGE] Calibration Overview screen with all sensors in a success state.}
\textbf{Figure 3.26} {[}NEED TO UPDATE IMAGE{]} Calibration Overview screen with all sensors in a success state. Once every required sensor has been calibrated, the "Proceed to Recording Data" button is enabled.
...
Because multi-sensor setup and calibration are procedural tasks with a high likelihood of breakdowns (e.g., missing prerequisites, unclear device state, poor signal quality, and repeated recalibration), the interface emphasises continuous visibility of system status, recognition over recall, error prevention, and support for recovery.
...
The study materials consisted of a participant information sheet (Appendix C), an informed consent form (Appendix D), the task prompts (Appendix A1 for the fragmented condition and Appendix A2 for the unified condition), per-condition observation and breakdown log sheets (Appendix E), the post-task open-response questionnaire (Appendix F), and post-task objective questionnaire comprising of System Usability Scale (SUS), the Raw NASA-TLX, and the calibration confidence rating (Appendix G).
...
On arrival, the participant was welcomed, given the participant information sheet (Appendix C), and briefed on the purpose of the study, including a short, non-evaluative introduction to eye tracking and biometric sensor technology. The participant then read and signed the informed consent form (Appendix D).
...
\textbf{Study documentation:} The participant records the study parameters manually in a provided Google Docs template (add in appendix ??), reflecting the absence of a unified study-creation interface. The parameters recorded are the same as those Sensa\textquotesingle s Study Setup flow captures in the unified condition: study name, study goal, interface type, test environment, sensors and metrics to use, number of participants, and study objectives. This ensures the documentation step is able to be compared across conditions and that time spent on study documentation is included consistently in the setup-time dependent variable for both conditions.

\textbf{Eye-tracking calibration:} The participant opens Tobii Core, positions themselves at the recommended viewing distance of approximately 60 cm from the screen-mounted eye tracker, and completes the calibration procedure with themselves as the calibration subject. The participant may refer to the printed extract from the Tobii Eye Tracking software user guide (Appendix H) if needed. They then validate the calibration using Tobii Core\textquotesingle s native gaze-trace visualisation, which provides a qualitative visual check of tracking quality but reports no numeric accuracy or precision values. Recalibration is repeated if the participant judges the result unsatisfactory, based on their own judgement of the qualitative gaze-trace visualisation, which is the only quality information Tobii Core exposes. The numeric calibration-quality data for this condition are not collected here; they are obtained afterwards through Sensa\textquotesingle s validation grid, administered as a separate measurement step (see Chapter 4.4.3).

\textbf{EDA sensor setup}: The participant places the EDA electrode using a printed reference sheet (Appendix I), ensures that the Biosignalsplux hub is connected via bluetooth, opens OpenSignals, and verifies signal presence by visual inspection of the live waveform. Signal verification in the baseline condition involves the participant visually confirming, on OpenSignals\textquotesingle{} live-waveform display, that the EDA channel shows: (a) a waveform that is present and oscillating (not flat-lined); and (b) no obvious clipping (no flat-topped peaks at the display boundaries); following an instruction on the task sheet to confirm whether the EDA waveform was flat or oscillating. A waveform that was present and oscillating (not flat-lined) and free of obvious clipping (no flat-topped peaks at the display boundaries) was treated as an acceptable signal. No quantitative threshold was applied at this step; this visual confirmation of waveform presence and the absence of obvious artifacts is the operational definition of signal verification for the baseline condition, consistent with the standard OpenSignals workflow it reflects (PLUX Wireless Biosignals S.A., 2026).
...
Dependent variables were calculated from three data sources, depending on the variable class. (1) Timing and breakdown metrics (H1, H4) were extracted from the session observation sheets and screen recordings (OBS Studio) through post-hoc annotation, with timestamps taken from the recording rather than from a live stopwatch. (2) Subjective measures, like NASA-TLX, SUS, and the calibration confidence rating (H2, H3) were computed from the standardised post-task questionnaires, scored according to each instrument\textquotesingle s published procedure. (3) Eye-tracking calibration quality metrics (H5) were computed from Sensa\textquotesingle s five-point validation grid (Chapter 3.3.4), which was applied in both conditions. In addition, the mean EDA resting baseline was computed from the 30-second recording using the shared transfer function and reported descriptively (see below). All dependent variables were calculated identically across the two conditions to ensure comparability, and because the design was within-subjects, each participant contributed a paired value per measure.
...
\item
  \begin{quote}
  \textbf{SUS Score (0--100):} overall perceived usability (See Appendix G Section 1).
  \end{quote}
\item
  \begin{quote}
  \textbf{Raw NASA-TLX (0--10):} six workload dimensions (mental, physical, temporal demand, performance, effort, frustration) (See Appendix G Section 2).
  \end{quote}
\item
  \begin{quote}
  \textbf{Calibration confidence rating (1-7 Likert-scale)}: perceived reliability and user confidence (See Appendix G Section 3).
  \end{quote}
\end{itemize}
...
\paragraph{4.6.1.2 Step 2: Reporting the effect sizes}\label{step-2-reporting-the-effect-sizes}}
...
\paragraph{4.6.1.3 Step 3: Analysing the binary outcome using McNemar's test}\label{step-3-analysing-the-binary-outcome-using-mcnemars-test}}
...
\paragraph{4.6.1.4 Step 4: Controlling for multiple comparisons}\label{step-4-controlling-for-multiple-comparisons}}

Since the study tests several hypotheses mapping to their own distinct research question, the analysis applies a Bonferroni correction within each hypothesis family, as opposed to applying it across the whole set of tests. Correcting across every measure at once would treat conceptually distinct questions like setup speed, workload, usability, breakdowns, and calibration quality all as a single family, and at this sample size would remove almost all statistical power. Correcting within each hypothesis keeps the correction meaningful while respecting that each hypothesis tests a different construct. Table 4.3 summarises the resulting families and their adjusted thresholds.
...
Finally, the mean EDA value serves only as a comparability check and not as a scored quality dimension. It is reported descriptively, as the mean and standard deviation per condition, to confirm that the resting baseline signal and its microsiemens conversion behaved consistently across the two conditions. Where a paired test accompanies these descriptives, it is read only as a check on the consistency of acquisition and conversion, not as a test of a study hypothesis.

\hypertarget{qualitative-analysis}{%
\subsubsection{4.6.2 Qualitative Analysis}\label{qualitative-analysis}}

The qualitative data consisted of the written open-ended post-task responses from the online questionnaire (Appendix F), supported by the observation and breakdown log sheets kept for each condition. Together these provided 24 response sets, one per participant in each of the two conditions, drawn from three sources: the five open-ended post-task questions, the open-ended item accompanying the confidence rating, and the researcher\textquotesingle s observation notes. These data were analysed using reflexive thematic analysis, following Braun and Clarke (2006, 2019).

\hypertarget{coding-approach}{%
\paragraph{\texorpdfstring{4.6.2.1 Coding approach }{4.6.2.1 Coding approach }}\label{coding-approach}}

Coding followed a hybrid deductive-inductive approach. Before the analysis, an initial set of deductive codes was defined from the study\textquotesingle s research focus, as seen in Appendix J Table J.1. These were derived from three sources: the five predefined interaction-breakdown categories (repeated calibration attempts, incorrect sequence execution, repeated baseline recording, hesitation periods, and requests for clarification), the study\textquotesingle s usability constructs (perceived workload, perceived usability, and calibration confidence), and the usability heuristics applied in the system design, principally visibility of system status, guidance and instructions, and error recovery. These codes were used to identify whether participants\textquotesingle{} responses and observed problems related to the issues the study was designed to examine, and gave twelve deductive codes in total.

During the analysis, eighteen additional inductive codes were developed directly from the participants\textquotesingle{} responses and the observation notes, as seen in Table J.2. These captured experiences not covered by the initial frame, including reassurance drawn from visible feedback, confusion regarding bluetooth connectivity, anxiety caused by visible readings that looked wrong, uncertainty about sensor placement, the effort of switching between disconnected tools, and the effect of growing familiarity across the two sessions. The deductive and inductive codes together formed a working codebook of thirty codes, reproduced in full in Appendix J.

\hypertarget{analytic-procedure}{%
\paragraph{4.6.2.2 Analytic procedure}\label{analytic-procedure}}

The analysis proceeded through the six phases described by Braun and Clarke, applied to this corpus as follows. Familiarisation involved repeated reading of all 24 response sets together with the accompanying observation notes. In the coding phase, each meaningful segment of text was assigned to one or more of the thirty codes, so that a single response could carry several codes where it expressed more than one experience. In searching for themes, the thirty codes were examined for shared underlying patterns and grouped into candidate themes. These candidates were then reviewed against the full set of coded extracts, during which codes were relocated, merged, or retained; one candidate concerning familiarity and order was kept as an interpretive rather than an experiential theme. Defining and naming produced five final themes: confidence grounded in system feedback; the burden of coordinating fragmented tools; guidance from the system; the limits of guidance; and familiarity and order effects. The final phase, producing the account, is presented in Chapter 5.2. The complete coding, showing every coded extract, the thirty codes, and their consolidation into the five themes, is provided in Appendix J so that the analysis can be inspected in full rather than through selected examples.

\hypertarget{coder-and-reflexivity}{%
\paragraph{4.6.2.3 Coder and reflexivity}\label{coder-and-reflexivity}}

The coding and thematic analysis were carried out by the author, consistent with the single-experimenter design of the study, and the author made all interpretive decisions. An AI assistant (Claude) was used to support the process by helping to organise and document the codes and to surface candidate groupings for the author to evaluate; all codes, themes, and interpretations were reviewed and determined by the author. In keeping with the reflexive, rather than coding-reliability, tradition of thematic analysis, the emphasis is on the transparency of the author\textquotesingle s interpretation, evidenced by the full coding in Appendix J, rather than on inter-coder agreement statistics.

As the designer of the unified onboarding and calibration workflow under evaluation, the author held a direct stake in the system being studied, which a reflexive analysis requires be acknowledged rather than set aside. This dual role carried a risk of reading participants\textquotesingle{} accounts more favourably towards the unified workflow. To counter this, the coding deliberately identified and retained the unified workflow\textquotesingle s shortcomings alongside its strengths, so that residual difficulties such as the sensor-placement ambiguity, the uninterpretable EDA values, and the cases in which visible feedback lowered rather than raised confidence appear in the themes as fully as the positive accounts. The complete coding in Appendix J allows the balance of this interpretation to be judged directly.
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{5.2}Shapiro-Wilk tests of normality on the within-participant difference scores, with the test applied to each measure.}
...
\begin{center}\includegraphics[width=0.62\linewidth]{media/media/image31.png}\end{center}
...
\begin{center}\includegraphics[width=0.62\linewidth]{media/media/image13.png}\end{center}
...
\begin{center}\includegraphics[width=0.62\linewidth]{media/media/image18.png}\end{center}
...
\begin{center}\includegraphics[width=0.62\linewidth]{media/media/image24.png}\end{center}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{5.3}Interaction breakdowns by category and condition (N = 12 per condition).}
\textbf{Table 5.3} Interaction breakdowns by category and condition (N = 12 per condition). Totals are the summed count across all participants; M is the mean per participant. The category counts sum to the total breakdown count analysed under H4.
...
\begin{center}\includegraphics[width=0.62\linewidth]{media/media/image22.png}\end{center}
...
\begin{quote}
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{5.4}First-pass calibration success: two-by-two contingency of first-attempt outcomes in the fragmented and unified conditions, with the exact McNemar test (N = 12; six discordant pairs).}
...
\begin{center}\includegraphics[width=0.62\linewidth]{media/media/image4.png}\end{center}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{5.5}Paired comparisons between conditions, with exact p-values, effect sizes and their 95 percent confidence intervals, family-wise thresholds, and outcomes after per-hypothesis Bonferroni correction (N = 12).}
...
Owing to the same Tobii calibration procedure being run in both conditions, any time difference reflects the surrounding workflow rather than the calibration algorithm itself. The qualitative findings suggest why: the fragmented workflow required additional tool-switching, navigation, and clarification, whereas the unified workflow organised these steps into a guided sequence. This would also explain why the reduction was clearer for calibration time than for the broader setup-time measure, since calibration is where the fragmented workflow\textquotesingle s tool-switching is densest. Reduced procedural overhead of this kind corresponds to the preparation burden described in prior work on multi-sensor setups (Aloi et al., 2024; Zhu \& Lv, 2023).
...
PLUX Wireless Biosignals, S.A. (2020). \emph{Electrodermal activity (EDA) sensor datasheet} (Rev. B). PLUX Wireless Biosignals, S.A. \href{https://support.pluxbiosignals.com/wp-content/uploads/2021/11/Electrodermal_Activity_EDA_Datasheet.pdf}{\ul{https://support.pluxbiosignals.com/wp-content/uploads/2021/11/Electrodermal\_Activity\_EDA\_Datasheet.pdf}}
...
\subsection{Appendix A1: Task Prompt (Fragmented Workflow)}\label{appendix-a1-task-prompt-fragmented-workflow}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.2842}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.7158}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Study Name}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\subsection{Appendix A2: Task Prompt (Unified Workflow)}\label{appendix-a2-task-prompt-unified-workflow}}
...
\subsection{\texorpdfstring{Appendix B: Participant Intake Form }{Appendix B: Participant Intake Form }}\label{appendix-b-participant-intake-form}}

The following intake form was administered to all participants via Google Forms before their study session. It captured contact details, demographic information, prior experience with the relevant technologies, and scheduling availability. Required questions are marked with an asterisk (*). The prior-experience items (questions 8 and 9) are the source of the descriptive experience data reported in Chapter 4.2; the contact and availability items were used for scheduling only and did not inform analysis.
...
\subsection{Appendix C: Participant Information Sheet}\label{appendix-c-participant-information-sheet}}
...
\textbf{Study title:} Designing and Evaluating Usability-Centred Calibration Workflows in Multi-Modal Physiological Research Platforms
...
\hypertarget{background-the-equipment-you-will-use}{%
\subsubsection{Background: the equipment you will use}\label{background-the-equipment-you-will-use}}
...
\hypertarget{is-participation-voluntary}{%
\subsubsection{Is participation voluntary?}\label{is-participation-voluntary}}
...
\hypertarget{are-there-any-risks}{%
\subsubsection{Are there any risks?}\label{are-there-any-risks}}
...
\hypertarget{will-your-data-be-kept-confidential}{%
\subsubsection{Will your data be kept confidential?}\label{will-your-data-be-kept-confidential}}
...
\hypertarget{will-you-be-recorded}{%
\subsubsection{Will you be recorded?}\label{will-you-be-recorded}}
...
\hypertarget{who-can-i-contact-with-questions}{%
\subsubsection{Who can I contact with questions?}\label{who-can-i-contact-with-questions}}
...
\subsection{Appendix D: Informed Consent Form}\label{appendix-d-informed-consent-form}}

This is the consent form each participant read and signed before the session began.

\hypertarget{informed-consent-form}{%
\subsection{Informed Consent Form}\label{informed-consent-form}}
...
\subsection{\texorpdfstring{Appendix E: Observation and Breakdown Log Sheets }{Appendix E: Observation and Breakdown Log Sheets }}\label{appendix-e-observation-and-breakdown-log-sheets}}
...
\hypertarget{session-observation-sheet-fragmented}{%
\section{Session Observation Sheet (Fragmented)}\label{session-observation-sheet-fragmented}}
...
\hypertarget{session-timestamps-for-condition}{%
\subsubsection{\texorpdfstring{Session Timestamps for condition: }{Session Timestamps for condition: }}\label{session-timestamps-for-condition}}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.6478}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.3522}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Event}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\hypertarget{breakdown-tally}{%
\subsubsection{Breakdown tally}\label{breakdown-tally}}

Tally each occurrence as it happens. Total at the bottom of each row.

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7048}}
...
\hypertarget{free-text-notes-and-participant-think-aloud-notes}{%
\subsubsection{\texorpdfstring{Free-text notes and participant think aloud notes: }{Free-text notes and participant think aloud notes: }}\label{free-text-notes-and-participant-think-aloud-notes}}

\emph{(Time-stamp each note where possible, e.g. "02:34, hesitated before performing eyetracking calibration")}

\hypertarget{researcher-overall-notes}{%
\subsubsection{\texorpdfstring{Researcher overall notes: }{Researcher overall notes: }}\label{researcher-overall-notes}}

\hypertarget{session-observation-sheet-unified}{%
\section{Session Observation Sheet (Unified)}\label{session-observation-sheet-unified}}
...
\hypertarget{session-timestamps-for-condition-1}{%
\subsubsection{\texorpdfstring{Session Timestamps for condition: }{Session Timestamps for condition: }}\label{session-timestamps-for-condition-1}}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.7035}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.2965}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Event}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\hypertarget{first-pass-calibration-success-h5}{%
\subsubsection{First-pass calibration success (H5)}\label{first-pass-calibration-success-h5}}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8186}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0944}}
...
\hypertarget{breakdown-tally-1}{%
\subsubsection{Breakdown tally}\label{breakdown-tally-1}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1582}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Breakdown type}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\hypertarget{captured-values-recorded-not-scored-for-h5-quality}{%
\subsubsection{Captured values (recorded, not scored for H5 quality)}\label{captured-values-recorded-not-scored-for-h5-quality}}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.7131}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.2869}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Value}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\subsection{\texorpdfstring{Appendix G: Post-Task Objective Questionnaires }{Appendix G: Post-Task Objective Questionnaires }}\label{appendix-g-post-task-objective-questionnaires}}
...
\subsection{\texorpdfstring{Appendix H: Tobii Eye Tracking Software Manual Extract }{Appendix H: Tobii Eye Tracking Software Manual Extract }}\label{appendix-h-tobii-eye-tracking-software-manual-extract}}
...
\emph{{[}Placeholder: drop the PDF into appendix/appendix-H.pdf and re-run convert.sh{]}}
...
\subsection{Appendix I: EDA Sensor Reference Datasheet}\label{appendix-i-eda-sensor-reference-datasheet}}
...
\emph{{[}Placeholder: drop the PDF into appendix/appendix-I.pdf and re-run convert.sh{]}}
...
\subsection{Appendix J: Full Thematic Coding}\label{appendix-j-full-thematic-coding}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1184}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3008}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5808}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{ID}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\textbf{Table J.1} Deductive codebook. The twelve codes and their definitions, derived before analysis from the interaction-breakdown categories, the usability constructs, and the Nielsen heuristics.
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1202}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4135}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4663}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{ID}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\textbf{Table J.2} Inductive codebook. The eighteen codes and their definitions, developed during analysis from the participants\textquotesingle{} written responses and the observation notes.
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3674}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3147}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Code}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\hypertarget{table-j.3-code-application-by-participant.-the-participants-in-whom-each-of-the-thirty-codes-appeared-split-by-condition.}{%
\paragraph{Table J.3 Code application by participant. The participants in whom each of the thirty codes appeared, split by condition.}\label{table-j.3-code-application-by-participant.-the-participants-in-whom-each-of-the-thirty-codes-appeared-split-by-condition.}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2172}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2303}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5525}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Theme}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\hypertarget{table-j.4-consolidation-into-themes.-the-codes-constituting-each-of-the-final-five-themes-with-the-rationale-for-grouping.}{%
\paragraph{\texorpdfstring{Table J.4 Consolidation into themes. The codes constituting each of the final five themes, with the rationale for grouping. }{Table J.4 Consolidation into themes. The codes constituting each of the final five themes, with the rationale for grouping. }}\label{table-j.4-consolidation-into-themes.-the-codes-constituting-each-of-the-final-five-themes-with-the-rationale-for-grouping.}}
...
\subsection{Appendix K: Per-Participant Quantitative Data}\label{appendix-k-per-participant-quantitative-data}}
...
Gaze accuracy and gaze precision are reported in degrees of visual angle. Interaction breakdown counts are totals across the five recorded categories, the per-category decomposition of which is given in Table 5.3. First-pass calibration success is recorded as pass or fail.

\begingroup\let\small\scriptsize\setlength{\tabcolsep}{2.5pt}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0738}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1001}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1001}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1317}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1317}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0685}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0685}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0422}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0422}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1106}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1106}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Participant}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Setup time (s) F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Setup time (s) U}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Calibration time (s) F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Calibration time (s) U}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{NASA-TLX F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{NASA-TLX U}
...
\textbf{SUS U}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Confidence (1-7) F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Confidence (1-7) U}
\end{minipage} \\
\begin{minipage}[b]{\linewidth}\raggedright
P01
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\textbf{Table K.1} Per-participant efficiency and subjective outcomes. Setup time, calibration time, Raw NASA-TLX, System Usability Scale, and calibration confidence for each participant (N = 12) in both conditions.

\begingroup\let\small\scriptsize\setlength{\tabcolsep}{2.5pt}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0618}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0662}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0662}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1059}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1059}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1104}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1104}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1104}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1104}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0662}}
...
\textbf{Breakdowns U}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Gaze accuracy (deg) F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Gaze accuracy (deg) U}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Gaze precision (deg) F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Gaze precision (deg) U}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Valid data yield (\%) F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Valid data yield (\%) U}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{First-pass F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{First-pass U}
...
\hypertarget{table-k.2-per-participant-interaction-breakdowns-and-eye-tracking-calibration-quality.-breakdown-counts-gaze-accuracy-gaze-precision-valid-data-yield-and-first-pass-calibration-success-for-each-participant-n-12-in-both-conditions.}{%
\subsubsection{Table K.2 Per-participant interaction breakdowns and eye-tracking calibration quality. Breakdown counts, gaze accuracy, gaze precision, valid data yield, and first-pass calibration success for each participant (N = 12) in both conditions.}\label{table-k.2-per-participant-interaction-breakdowns-and-eye-tracking-calibration-quality.-breakdown-counts-gaze-accuracy-gaze-precision-valid-data-yield-and-first-pass-calibration-success-for-each-participant-n-12-in-both-conditions.}}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2388}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3839}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3772}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Participant}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{EDA baseline (uS) F}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{EDA baseline (uS) U}
\end{minipage} \\
\begin{minipage}[b]{\linewidth}\raggedright
P01
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\hypertarget{table-k.3-per-participant-mean-resting-eda-baseline.-mean-resting-electrodermal-activity-in-microsiemens-for-each-participant-n-12-in-both-conditions.}{%
\subsubsection{Table K.3 Per-participant mean resting EDA baseline. Mean resting electrodermal activity in microsiemens for each participant (N = 12) in both conditions.}\label{table-k.3-per-participant-mean-resting-eda-baseline.-mean-resting-electrodermal-activity-in-microsiemens-for-each-participant-n-12-in-both-conditions.}}

\hypertarget{ai-usage-disclosure}{%
\section{AI Usage Disclosure}\label{ai-usage-disclosure}}

\hypertarget{declaration-of-authenticity}{%
\section{\texorpdfstring{Declaration of Authenticity }{Declaration of Authenticity }}\label{declaration-of-authenticity}}

Please attach the following text: Declaration I, First Name Name, declare that the research work presented here is from the best of my knowledge and belief, original and the result of my own investigations. The cooperation I got for this research work is clearly acknowledged. To the best of my knowledge, it does not contain any materials those are written by others or published already except mentioned with due references in the text as well as with the quotation marks. This work has not been published, submitted, either in part or whole intended for reward, degree at this or any other University. Kleve, Date Signature (in term papers the name is sufficient)
