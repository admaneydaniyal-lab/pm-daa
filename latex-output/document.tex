...
{\huge\bfseries Designing and Evaluating Usability-Centred Onboarding and Calibration Workflows in Multi-Modal Research Platforms.\par}
\vspace{2.5cm}
{\large Daniyal Admany - 35795}\\[1cm]
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1195}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1019}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1725}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.4939}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0627}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1490}}@{}}
\toprule\noalign{}
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{Hypothesis}
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
...
\textbf{Table K.2 Per-participant interaction breakdowns and eye-tracking calibration quality. Breakdown counts, gaze accuracy, gaze precision, valid data yield, and first-pass calibration success for each participant (N = 12) in both conditions.}
\endgroup
\end{landscape}
...
\textbf{Table K.3 Per-participant mean resting EDA baseline. Mean resting electrodermal activity in microsiemens for each participant (N = 12) in both conditions.}
