...
\begin{center}\includegraphics[max width=0.85\linewidth,max totalheight=0.85\textheight]{diagrams/figure-3.20.pdf}\end{center}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{J.1}Deductive codebook.}%
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{J.2}Inductive codebook.}%
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{J.3}Code application by participant.}%
\textbf{Table J.3} Code application by participant. The participants in whom each of the thirty codes appeared, split by condition.
...
\begingroup\let\small\footnotesize\setlength{\tabcolsep}{4pt}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0900}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0963}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0956}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1277}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1277}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0684}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0684}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0450}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0450}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1080}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1080}}@{}}
\toprule\noalign{}
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{Participant}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{K.1}Per-participant efficiency and subjective outcomes.}%
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0931}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0985}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0985}}
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{K.2}Per-participant interaction breakdowns and eye-tracking calibration quality.}%
...
\phantomsection\addcontentsline{lot}{table}{\protect\numberline{K.3}Per-participant mean resting EDA baseline.}%
