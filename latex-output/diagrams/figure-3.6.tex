...
\begin{tikzpicture}[node distance=0pt]
  ...
  \node[blue]   (manual)at (0,-13.4)  {Select Sensors Manually};
  \node[blue]   (proj)  at (7,-13.4)  {Project Details Form};
  \node[orange] (ready) at (11,-13.4) {Pre-Calibration Readiness Check};
  ...
  % decision branches
  \draw[flow] (sens.west) -- node[elabel,above]{Reject Recommendation} ++(-3.6,0) |- (manual.east);
  \draw[flow] (sens.east) -- node[elabel,above]{Accept Recommendation} ++(1.8,0) |- (proj.north);
